...
public class ProductController {
    ...
    private ResponseEntity<String> updateProduct(@PathVariable int id, @RequestPart Product product,
    ...
    private ResponseEntity<String> deleteProduct(@PathVariable int id) {
        Product product = service.getProductById(id);
        ...
        if (product != null) {
            ...
            return new ResponseEntity<>("Product not found, Failed to delete", HttpStatus.NOT_FOUND);
